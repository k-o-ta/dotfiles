...
nmap <silent> gs :<C-u>call CocActionAsync('jumpDefinition', 'vsplit')<CR>
nmap <silent> gx :<C-u>call CocActionAsync('jumpDefinition', 'split')<CR>
...
set statusline^=%{coc#status()}%{get(b:,'coc_current_function','')}%=%l,%02v\ %<%f
